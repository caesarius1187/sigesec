...
(/** @lends <global> */function($, window, document, undefined) {
				...
				for ( i=0, iLen=aoData.length ; i<iLen ; i++ )
				{
					for ( j=0 ; j<iSortLen ; j++ )
					{
						...
						{							
							...
							//alert(_fnGetCellData( oSettings, i, aDataSort[k], 'sort' ))
							if (sDataType != 'date')
							{								
							...
							{
								//Modificacion para poder ordenar el tipo fecha ya que usamos el formato d/m/y y no y/m/d
								aoData[i]._aSortData[ aDataSort[k] ] = _fnGetCellData( oSettings, i, aDataSort[k], 'sort' );
							}
							//alert(fnSortFormat( _fnGetCellData( oSettings, i, aDataSort[k], 'sort' ) ))							
							//aoData[i]._aSortData[ aDataSort[k] ] = fnSortFormat ? alert('igual') : alert('difer');
						}
					}
				}
				...
				oSettings.aiDisplayMaster.sort( function ( a, b ) {
					...
					for ( k=0 ; k<iSortLen ; k++ )
					{
						...
						for ( l=0, lLen=aDataSort.length ; l<lLen ; l++ )
						{
							...
							//alert(sDataType);alert(aaSort[k][1])
							//alert(aoData[a]._aSortData[ aDataSort[l]]);
							//alert(aoData[b]._aSortData[ aDataSort[l]])
							//alert(aoData[a]._aData[iDataSort]);
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			 ...
			 *    } );
			 */
			"sInfo": "Resultado _START_ a _END_ de _TOTAL_ registros",
