...
function calculateRow($numRow,$iniRow,$finRow,$gcliActual,&$puedePagar,&$totLPago){
                                 ...
                                 <tr>
                                    <?php 
                                            ...
                                            <td style="<?php echo $color; ?>" title="<?php echo $title?>">
                                                <?php echo "$".number_format($eventosimpuesto["montovto"],2,",",".")?>
                                            </td>
                                 </tr>             
                            <?php }   
                             }                             
   ...
   <?php }?>
<?php echo $this->Html->script('clientes/pagosdelmes',array('inline'=>false));?>
...
<div id="Formhead" class="clientes informepagosdelmes index" style="margin-bottom:10px;">
    ...
    <?php echo $this->Form->create('clientes',array('action' => 'pagosdelmes')); ?> 
    <table class="tbl_informepagosdelmes tblInforme">
        ...
        <tr> 
            <td>
             <?php
                echo $this->Form->input('gclis', array(                    
                    ...
                    'onChange'=> 'setPrevNextButton()',
                ));?>
            </td>
            <td id='tdGcliPrevio'>
                <div class="submit" >
                    <?php
                        echo $this->Form->input('anterior', array(                    
                            'onClick' => 'gcliPrevio();', 
                            'type'=>'submit',
                            'label' => false, 
                            'id'=>'btnGcliPrevio'
            ...
            <td id='tdGcliSiguiente'>
                 <div class="submit">
                     <?php
                        echo $this->Form->input('siguiente', array(                    
                            'onClick' => 'gcliSiguiente();', 
                            'type'=>'submit',
                            'label' => false,    
                            'id'=>'btnGcliSiguiente'                        
                        ));?>
...
<table id="pagosdelmes" cellspacing="0" style="width:60%">
    ...
    foreach ($grupoclientesActual as $gcliActual ) {?>
        <tr >
            <th class="sithead" colspan="6" align="left">GRUPO:<?php echo utf8_decode($gcliActual["Grupocliente"]["nombre"])?> </th>                        
        </tr>          
        <tr>
