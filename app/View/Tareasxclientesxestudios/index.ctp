...
<div class="tareas index">
	...
	<tr>
		...
		<td><?php echo h($tareasxclientesxestudio['Tareasxclientesxestudio']['tipo']); ?>&nbsp;</td>
   		<td><input type="button" style="width: 50%; font-size: 100%;background-color: transparent; border: 1px solid transparent;" value="<?php echo $tareasxclientesxestudio['User']['nombre']?>" onclick="loadTareaId(<?php echo $tareasxclientesxestudio['Tareasxclientesxestudio']['id']?>)" /></td>
